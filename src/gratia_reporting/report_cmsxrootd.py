...
import string
import datetime
import gratia_reporting.GetOverflowjobsInfo7 as GetOverflowjobsInfo7
...
class Report(object):
    ...
    def generatePlain(self):
        ...
        text += GetOverflowjobsInfo7.mainGetOverflowjobsInfo1() + "\n"
        
        text += self.generatePerSiteClient() + "\n"
        
        text += self.generatePerUser() + "\n"

        # Newly added xrootd's another report
        text += GetOverflowjobsInfo7.mainGetOverflowjobsInfo2()
        self._logger.info("\n" + text)
        return text
